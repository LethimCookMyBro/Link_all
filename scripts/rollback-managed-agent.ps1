...
.\.venv\Scripts\python.exe -m pytest tests/test_protocol_auth.py -q
if ($LASTEXITCODE -ne 0) { throw 'Legacy protocol verification failed after rollback' }
.\.venv\Scripts\python.exe -m pytest tests/test_c2_coverage.py -q
